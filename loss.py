...
def calc_gan_loss(discriminator, output, target):
    y_pred_fake, y_pred_fake_local = discriminator(output, target)
    y_pred, y_pred_local = discriminator(target, output)
    ...
    return g_loss + g_loss_local, d_loss + d_loss_local
